...
void searchByDate(int page) {
    string folderPath;
    switch (page) {
    case 1: folderPath = "../data/prehistoric"; break;
    case 2: folderPath = "../data/classical"; break;
    case 3: folderPath = "../data/middleAge"; break;
    case 4: folderPath = "../data/earlyModern"; break;
    case 5: folderPath = "../data/modern"; break;
    default: return;
    }
